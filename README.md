...
**1、永久会员于2026年7月1日10:00已取消，涨价已提前半年在购买页面通知，目前只有年费会员。**

**2、鸿蒙微信备份失败，首先先检查一下8011、24011端口是否被占用，如果被占用，先停用占用的应用，使用完微备份后，再恢复原使用8011、24011端口的应用。（更多详情请看下面的【常见问题】）** 

**3、会员变试用，先检查一下飞牛是否开启了防火墙？需要对端口9014、24011、8011、20360~20367允许全部协议出入访问，且保证这些端口不被占用，然后在【应用中心-微备份-停用，再启用】。**

**4、微备份v1.0.7.0（v1.0.7）开始 已支持海外微信号、飞牛OS ARM版。** 

**5、微备份v1.1.0.0（v1.1.0）开始 已支持鸿蒙版微信（保证8011、24011端口不被占用）。** 

**6、微备份v1.2.0.0（v1.2.0）开始 已支持把微信数据从NAS恢复到鸿蒙/苹果/安卓手机。** 

**7、如遇到“无法登录/备份、更换/重装设备、无昵称、无头像、恢复备份、会员权益”等【常见问题】往下翻即可找到。** 
...
#### 关于会员权益的说明（永久会员于2026年7月1日10:00已取消，涨价通知已提前半年通知，目前只有年费会员）
